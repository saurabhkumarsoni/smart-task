...
class OrganizationService:
    ...
    def create_organization(self, data: OrganizationCreate | dict, current_user: User):
    ...
    def get_user_organizations(self, current_user: User):
        query = (
            select(Organization)
            .join(
                OrganizationMember,
    ...
    def get_organization(self, organization_id: UUID):
        org = self.db.scalar(
    ...
    def update_organization(
        self, organization_id: UUID, data: OrganizationUpdate | dict
    ):
    ...
    def add_member(self, organization_id: UUID, data: OrganizationMemberCreate | dict):
        ...
        member = OrganizationMember(
            ...
            role=payload.get("role", OrganizationRole.MEMBER),
        )
        self.db.add(member)
        self.db.commit()
    ...
    def get_members(self, organization_id: UUID):
        self.get_organization(organization_id)
